return {
	...
	config = function()
		...
		vim.keymap.set(
			...
			{ desc = "toggle debug break points", noremap = true, silent = true }
		)
		...
		vim.keymap.set(
			...
			"<leader>rl",
			dap.run_last,
			{ desc = "runs last debug profile", noremap = true, silent = true }
		)
		...
		vim.keymap.set(
			...
			"<leader>r0",
			dap.step_out,
			{ desc = "step out of the code", noremap = true, silent = true }
		)
